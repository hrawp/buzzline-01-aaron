...
ADJECTIVES: list = ["amazing", "boring", "not enough", "exciting", "weird", "exhilarating", "no big deal"]
ACTIONS: list = ["made", "lost", "gained", "raised", "spent", "put", "wagered"]
TOPICS: list = ["$50.00", "$1,000.00", "$20,000.00", "$130,000.00", "$343.00", "$4,000.00", "$53,000.00", "$275,000.00", "$1.50"]
ACTIVITIES: list = ["Penny Stock", "Fantesy Football", "Sports Betting", "Stock Options", "Ethereum", "TQQQ ETF"]
...
def generate_messages():
    ...
    while True:
        ...
        yield f"I just {action} {topic} on {activities} {time}! It was {adjective}."
